...
### 🚀 Sobre Mim
Sou estudante de **Sistemas para Internet** no **IFTM (Instituto Federal Triângulo Mineiro)**. Sou apaixonado por tecnologia e focado em desenvolver aplicações eficientes, combinando o aprendizado acadêmico com projetos práticos de desenvolvimento web e back-end.

* 🎓 Graduando em Sistemas para Internet no IFTM
* 🌱 Atualmente aprofundando meus conhecimentos em desenvolvimento robusto com Java e Go
* ⚡ Buscando sempre evoluir na criação de interfaces modernas e APIs escaláveis
